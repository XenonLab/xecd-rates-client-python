...
Can also be executed with string input parameters:
    xecd = XecdClient('accountId', 'apiKey')

*Depending on what url you run these tests from, it might take quite awhile
...
#xecd.options['baseUrl'] = 'https://xecdapi.xedevelopment.com/v1/' #for XE.com devs (different credentials)
    #also note the XE dev server only keeps historic data for a year
